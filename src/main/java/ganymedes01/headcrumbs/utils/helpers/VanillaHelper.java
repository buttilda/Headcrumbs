...
public class VanillaHelper extends HeadDropHelper {
	...
	// but it would stop heads from dropping from other mod's mobs that
	...
	if (entity instanceof EntityMob) {
		...
		return SkullTypes.wither.getStack(
			1 + (entity.worldObj.rand.nextInt(100) == 0 ? 1 + entity.worldObj.rand.nextInt(2) : 0));
