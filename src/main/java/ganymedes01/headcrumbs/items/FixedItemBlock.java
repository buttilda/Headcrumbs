...
public abstract class FixedItemBlock extends ItemBlock {
	...
	if (stack.func_190916_E() == 0)
	    ...
	    IBlockState newState = this.block.getStateForPlacement(world, pos, facing, hitX, hitY, hitZ, meta, player,
		    hand);
    ...
    public boolean canBlockBePlaced(World world, Block blockToPlace, BlockPos pos, boolean useBounds, EnumFacing side,
