...
public class ShadowPersonClassicHead extends ModelHead {
	
	public static final ShadowPersonClassicHead INSTANCE = new ShadowPersonClassicHead();
	
	protected ShadowPersonClassicHead() {
	}
