...
public class CambionHead extends ModelHead {
	
	public static final CambionHead INSTANCE = new CambionHead();
	
	protected CambionHead() {
	}
	...
	public void init() {
		...
		ModelRenderer lowerJaw = new ModelRenderer(this, 21, 46);
		lowerJaw.setRotationPoint(0.0F, -0.4F, -4.0F);
		...
		snout.setRotationPoint(0.0F, -2.5F, -3.9F);
		snout.addBox(-1.5F, -1.0F, -2.0F, 3, 2, 3, 0.0F);
		setRotateAngle(snout, 0.41887902047863906F, 0.0F, 0.0F);

		ModelRenderer upperJaw = new ModelRenderer(this, 21, 41);
		upperJaw.setRotationPoint(0.0F, -1.4F, -4.0F);
