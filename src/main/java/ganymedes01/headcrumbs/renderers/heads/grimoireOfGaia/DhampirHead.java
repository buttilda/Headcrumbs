...
public class DhampirHead extends ModelHead {
	...
	public void init() {
		...
		hat01.addBox(-6.0F, -7.0F, -6.0F, 12, 2, 12);
		...
		hat02.addBox(-3.0F, -10.0F, -3.0F, 6, 3, 6);
		...
		hat03.addBox(-4.0F, -11.0F, 0.0F, 4, 3, 4);
		...
		hatflower.addBox(-3.5F, -11.0F, -3.5F, 7, 4, 7);
		...
		lefthair.addBox(1.0F, -5.0F, -4.0F, 4, 4, 1);
