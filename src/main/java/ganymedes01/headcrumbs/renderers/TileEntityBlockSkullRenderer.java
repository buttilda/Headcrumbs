...
public class TileEntityBlockSkullRenderer extends TileEntitySpecialRenderer<TileEntityBlockSkull>
{
	...
	@Override
	public void render(TileEntityBlockSkull tile, double x, double y, double z, float partialTickTime, int destroyStage, float p_192841_10_)
	{
	...
	public void renderHead(float x, float y, float z, int meta, float skullRotation, HeadDrop type, GameProfile profile, int destroyStage)
	{
		if(destroyStage >= 0)
		{
