...
public class Headcrumbs {
	...
	public static String[] modders = {
		...
		"ganymedes01", "Pokefenn", "chylex", "vadis365", "jakimfett", "mezz"
	};
	...
	public static String[] forgeCraft = {
		...
		"neptunepink", "EddieRuckus", "LordDusk", "Kihira", "Vaygrim", "Kaelten", "MatrexsVigil", "tfox83"
	};

	public static String[] ftb = {
		"eyamaz", "jadedcat", "slowpoke101", "progwml6"
	};
	// @formatter:on
