...
public class Headcrumbs {
	...
	public static String[] modders = { "Reika_Kalseki", "MatrexsVigil", "ganymedes01", "Pokefenn", "chylex", "vadis365", "CrazyPants", "Kihira", "Country_Gamer", "jakimfett", "mats000", "kris545545" };
